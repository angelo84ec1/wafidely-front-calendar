...
<section class="hero-bg min-h-screen flex items-center justify-center relative overflow-hidden">
          ...
          <div class="grid lg:grid-cols-12 gap-8 items-center">
            ...
            <div class="lg:col-span-8 text-center lg:text-left animate-slide-up">
              ...
              <div class="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 mb-8 border border-white/30 shadow-lg">
                <span class="text-white text-sm font-semibold drop-shadow-sm">🚀 New: Advanced Conversational AI</span>
              </div>
              ...
              <h1 class="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white mb-6 leading-tight drop-shadow-lg">
                Automate your<span class="text-green-400 drop-shadow-md">WhatsApp Business</span><br>
                con <span class="text-blue-400 drop-shadow-md">Artificial Intelligence</span>
              </h1>
              
              <!-- Subheadline with better contrast -->
              <p class="text-lg md:text-xl lg:text-2xl text-gray-100 mb-8 leading-relaxed drop-shadow-md">
                Increase your sales up to <strong class="text-yellow-400 text-xl md:text-3xl">7x</strong> with intelligent bots that respond like humans, 
              manage appointments automatically, and convert visitors into customers 24/7.
              </p>
              ...
              <div class="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-4 mb-8">
                ...
                >
                  <span class="group-hover:text-green-600 transition-colors">🎯 Start Free Trial</span>
                </button>
              </div>
              ...
              <div class="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-6 text-white">
                <div class="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 border border-white/20">
                  ...
                  <span class="text-sm font-semibold drop-shadow-sm">+200 companies trust us</span>
                </div>
          ...
          <div class="max-w-6xl mx-auto">
            <div class="text-center mb-16">
              ...
              <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                Thousands of businesses lose sales daily because they can't serve WhatsApp 24/7
              </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
              <!-- Problems -->
              <div class="space-y-6">
                <h3 class="text-2xl font-bold text-red-600 mb-6">❌ Without Wafidely AI</h3>
                <div class="space-y-4">
                  <div 
              ...
              <!-- Solutions -->
              <div class="space-y-6">
                <h3 class="text-2xl font-bold text-green-600 mb-6">✅ With Wafidely AI</h3>
                <div class="space-y-4">
                  <div 
        ...
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-3xl md:text-5xl font-bold text-gray-800 mb-4">
              Features that <span class="gradient-text">Revolutionize</span> your Business
            </h2>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
              Cutting-edge technology designed to maximize your conversions and fully automate your WhatsApp Business
            </p>
          </div>
        ...
        <div class="container mx-auto px-4 text-center">
          <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">
              See Wafidely AI in Action
            </h2>
            <p class="text-xl text-green-100 mb-12">
              Tour of our WhatsApp Business integration admin panel
            </p>
    ...
    <div class="relative bg-white bg-opacity-10 rounded-2xl p-8 backdrop-filter backdrop-blur-lg">
      ...
      <p class="text-white mt-4 text-sm opacity-90">
        📹 6-minute demo: Steps to integrate WhatsApp Business with AI, sales funnel creation and appointment reminders
      </p>
    </div>
            ...
            <div class="grid grid-cols-3 gap-8 mt-12 text-white">
              <div>
                ...
                <p class="text-green-100">Increase in leads</p>
              </div>
              <div>
                <div class="text-3xl font-bold mb-2">6 min</div>
                <p class="text-green-100">Integration time</p>
              </div>
              <div>
                <div class="text-3xl font-bold mb-2">100%</div>
                <p class="text-green-100">Scalable</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600">
              More than 200 companies trust Wafidely AI to automate their sales
            </p>
          </div>
      ...
      <section id="pricing" class="py-20 bg-white">
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Plans that Adapt to your <span class="gradient-text">Growth</span>
            </h2>
            <p class="text-xl text-gray-600 mb-8">
              Start free and scale according to your needs. No surprises, no long commitments.
            </p>
            ...
            <div class="flex items-center justify-center gap-4 mb-12">
              ...
              <span class="text-green-600 font-semibold">Annual (2 months free)</span>
            </div>
          </div>
                ...
                >
                  ...
                  >
                    ...
                    <div class="text-center mb-8">
                      ...
                      <!-- Original price crossed out (only if there's discount) -->
                      ...
                      <p class="text-gray-600">{{ plan.id === 0 ? 'For 5 days' : (isAnnual ? 'Per year' : 'Per month') }}</p>
                    </div>
  ...
  <div class="text-center mb-6">
    ...
    <div class="bg-gray-90 text-gray-500 px-4 py-2 rounded-t-lg text-sm font-semibold">
      Includes AI automatic responses for sales, support, customer service on:
    </div>
    ...
    <div class="bg-gray-50 p-4 rounded-b-lg border border-gray-200">
        ...
        <div class="flex justify-center items-center space-x-6">
          ...
          <div class="text-center mt-12">
            <div class="inline-flex items-center gap-3 bg-[#38f5b3] px-6 py-4 rounded-full border border-[#38f5b3]">
              ...
              <span class="text-gray-700 font-semibold">Our guarantee is the FREE 5-day demo trial without credit card</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- FAQ Section -->
      <section id="faq" class="py-20 bg-[#FBF8FF]">
        <div class="container mx-auto px-4">
          <div class="max-w-4xl mx-auto">
            <div class="text-center mb-16">
              <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              ...
              <p class="text-xl text-gray-600">
                We answer your most common questions about Wafidely AI
              </p>
            </div>
        ...
        <div class="container mx-auto px-4 text-center">
          <div class="max-w-4xl mx-auto">
            ...
            <p class="text-xl md:text-2xl text-green-100 mb-8">
              Join more than 200 companies that have already automated their WhatsApp Business with AI
            </p>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              >
                ⏱️ 🚀 Book your FREE 1:1 Demo - Discover the Power of AI
              </button>
            </div>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-8 text-green-100 mb-12">
              ...
              <div class="flex items-center gap-2">
                <span class="text-lg">✅</span>
                <span>Free cloud installation</span>
              </div>
              <div class="flex items-center gap-2">
                <span class="text-lg">✅</span>
            ...
            <div class="bg-white bg-opacity-10 rounded-xl p-6 backdrop-filter backdrop-blur-lg">
              <p class="text-lg font-semibold mb-2">⏰ Limited Offer</p>
              <p class="text-green-100">All 3 plans include 37,000 to 57,000 inbound and outbound conversations per month with Open AI</p>
              <div class="mt-4 text-2xl font-bold">⏱️ {{ remainingSpots }} spots remaining</div>
            </div>
          </div>
        </div>
      </section>
  ...
  // SEO and Meta tags optimized for Nuxt 3
  useSeoMeta({
    title: 'Wafidely AI - Automate your WhatsApp Business with Artificial Intelligence',
    ogTitle: 'Wafidely AI - Automate your WhatsApp Business with AI',
    description: 'Increase your sales up to 7x with Wafidely AI. Complete WhatsApp Business automation, intelligent bots, conversational AI and 24/7 customer management. Try free.',
    ogDescription: 'Increase your sales up to 7x with intelligent WhatsApp Business automation. AI bots, automatic responses and complete customer management.',
    ogImage: '/images/wafidely-ai-og.jpg',
    ogUrl: 'https://www.wafidely.com/ai',
    twitterTitle: 'Wafidely AI - Automate your WhatsApp Business with AI',
    twitterDescription: 'Increase your sales up to 7x with intelligent WhatsApp Business automation.',
  ...
  const setupVideo = () => {
    if (demoVideo.value && isInitialSetup.value) {
      // Use timeout to ensure video is completely loaded
      setTimeout(() => {
        if (demoVideo.value) {
          demoVideo.value.currentTime = 3 // Set to 3 seconds (0:03)
  ...
  const onSeeked = () => {
    // Ensure it pauses after seeking initial position
  ...
  const onPlay = () => {
    if (demoVideo.value && !hasStartedPlaying.value) {
      // First time pressing play - restart from second 0
  ...
  // METHODS TO HANDLE PRICES WITH DISCOUNT
  const hasDiscount = (plan: PricingPlan) => {
    if (isAnnual.value) {
      // For annual plans, there's always discount (2 months free)
      return true
    } else {
      // For monthly plans, check if there's discountPrice
  ...
  const getOriginalPrice = (plan: PricingPlan) => {
    if (isAnnual.value) {
      // Original annual price would be 12 months of monthly price
  ...
  const getDisplayPrice = (plan: PricingPlan) => {
    if (isAnnual.value) {
      // For annual, show annual price (which includes 2 months free)
      return plan.annualPrice
    } else {
      // For monthly, show discountPrice if exists, otherwise monthlyPrice
  ...
  const getDiscountPercentage = (plan: PricingPlan) => {
    ...
    // Avoid division by zero for free plan
    if (originalPrice === 0) return 0
    
    return Math.round(((originalPrice - displayPrice) / originalPrice) * 100)
  }
  
  // Data arrays with TypeScript typing
  interface Problem {
    id: number
    title: string
    description: string
  ...
  const problems = ref<Problem[]>([
    {
      id: 1,
      title: 'Slow or missed responses',
      description: 'Customers expect immediate responses, but your team can\'t be available 24/7'
    },
    {
      id: 2,
      title: 'Overwhelming manual management',
      description: 'Responding to each message individually consumes valuable time and resources'
    },
    {
      id: 3,
      title: 'Lost sales',
      description: 'Interested customers go to competitors due to lack of immediate attention'
    }
  ])
  ...
  const solutions = ref<Solution[]>([
    {
      ...
      description: 'Intelligent bots respond in seconds, 24 hours a day, 7 days a week'
    },
    {
      id: 2,
      title: 'Complete automation',
      description: 'Manages thousands of conversations simultaneously without manual intervention'
    },
    {
      id: 3,
      title: 'Maximized conversions',
      description: 'Every visitor becomes a sales opportunity with automatic follow-up'
    }
  ])
  ...
  const mainFeatures = ref<MainFeature[]>([
    {
      ...
      description: 'Chatbots that understand context and respond like humans using GPT technology',
    ...
    },
    {
      id: 2,
      title: 'Complete Automation',
      description: 'Automated workflows that handle the entire sales cycle without intervention',
      iconPath: 'M13 10V3L4 14h7v7l9-11h-7z',
      benefits: [
        'Automatic lead segmentation',
        'Personalized follow-up',
        'Recovery of unattended contacts'
      ]
    },
    {
      id: 3,
      title: 'Intelligent Analytics',
      description: 'Detailed metrics and actionable insights to optimize your strategy',
      iconPath: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
      benefits: [
        'Real-time dashboards',
        'Advanced ROI tracking',
        'AI token consumption status'
      ]
    }
  ])
  ...
  const extraFeatures = ref<ExtraFeature[]>([
    {
      ...
      description: 'Automatically prioritizes leads with highest potential',
      emoji: '🎯'
    },
    {
      id: 2,
      title: 'Integration with 30+ Webhooks',
      description: 'Synchronizes with your favorite tools automatically',
      emoji: '🔄'
    },
    {
      id: 3,
      title: 'AI Scheduling',
      description: 'Schedules appointments automatically according to availability',
      emoji: '📅'
    },
    {
      id: 4,
      title: 'Multi-language',
      description: 'Serves customers in more than 3 languages automatically',
      emoji: '🌍'
    }
  ])
  ...
  const testimonials = ref<Testimonial[]>([
    {
      ...
      initials: 'RC',
      quote: 'Wafidely AI completely transformed our business. In just 2 months we increased our sales by 200% and now we serve customers 24/7 without additional effort in car rentals.',
      result: 'Result: +200% in sales'
    },
    {
      id: 2,
      name: 'Hugo Moncayo',
      ...
      initials: 'HM',
      quote: 'Wafidely automation allows us to remind patients of hundreds of medical appointment consultations. Our team focuses on keeping the schedule full of patients without absences.',
      result: 'Result: 80% fewer absences'
    },
    {
      id: 3,
      name: 'Ana García',
      position: 'Founder, Modern Dental Clinic',
      initials: 'AG',
      quote: 'Automatic appointment scheduling changed our lives. Patients can schedule 24/7 and we confirm automatically. Incredible!',
      result: 'Result: +310% scheduled appointments'
    }
  ])
  ...
  const pricingPlans = ref<PricingPlan[]>([
    {
      id: 0,
      name: 'WAFree',
      description: 'Free trial to get to know our service',
      descountPrice: 0,
      monthlyPrice: 0,
      annualPrice: 0,
      popular: false,
      ...
      features: [
        '1 Flow Builder',
        '2 WhatsApp numbers for integration',
        '1000 AI Tokens for 5 days',
        'Free support to create account'
      ]
    },
    {
      id: 1,
      ...
      features: [
        '3 Complete Flow Builders',
        'Up to 75 conversations/month',
        '4,000-8,000 AI tokens',
        'Up to 300 contacts in campaigns',
        'WhatsApp support'
      ]
    },
    {
      id: 2,
      name: 'WAPyme',
      description: 'Perfect for SMEs with moderate users',
      descountPrice: 69,
      monthlyPrice: 89,
      annualPrice: 690,
      popular: false,
      buttonText: 'Start Now',
      features: [
        'Automatic reminder up to 100 appointments',
        'Advanced Flow Builder',
        'Automatically generated page',
        'Complete reports',
        'Up to 140 conversations/month',
        '17,000-20,000 AI tokens',
        'Up to 500 contacts in campaigns',
        'Priority support'
      ]
    },
    {
      ...
      buttonText: 'Start',
      features: [
        'Automatic reminder up to 300 appointments',
        'Complete WhatsApp API',
        'Multiple landing pages',
        'Advanced analytics',
        'Up to 350 conversations/month',
        '20,000-29,000 AI tokens',
        'Up to 1,000 contacts in campaigns',
        '24/7 support'
      ]
    },
    {
      ...
      buttonText: 'Start',
      features: [
        'Automatic reminder up to 1,000 appointments',
        'Complete enterprise API',
        'Multiple integrations',
        'Custom reports',
        'Up to 720 conversations/month',
        '29,000-67,000 AI tokens',
        'Up to 5,000 contacts in campaigns',
  ...
  id: 5,
  name: 'WACustom',
  description: 'For companies with multiple systems',
  ...
  features: [
    'Automatic reminders up to 5,000 appointments',
    'Enterprise API with integration to existing company systems',
    'Multiple integrations',
    'Custom reports',
    'Unlimited conversations/month',
    'Unlimited AI tokens',
    'From 100,000+ contacts in campaigns',
    'Dedicated account manager'
  ]
}
  ])
  ...
  const faqs = ref<FAQ[]>([
    {
      id: 1,
      question: 'How difficult is it to set up Wafidely AI?',
      answer: 'Super easy. Our setup wizard guides you step by step and you can have your first bot running in less than 10 minutes. Plus, our team helps you for free with the initial setup.',
      isOpen: false
    },
    {
      id: 2,
      question: 'Does it work with my current WhatsApp Business?',
      answer: 'Absolutely! Wafidely AI integrates seamlessly with your existing WhatsApp Business account. You don\'t need to change numbers or lose your conversation history.',
      isOpen: false
    },
    {
      id: 3,
      question: 'What if my customers realize it\'s a bot?',
      answer: 'Our AI bots are so natural that 95% of customers don\'t notice the difference. And if they need human attention, the bot automatically transfers the conversation to your team.',
      isOpen: false
    },
    {
      id: 4,
      question: 'How long does it take to see results?',
      answer: 'Our customers typically see a 130-300% increase in leads in the first 2 weeks. Sales results are usually seen between 15-30 days after implementation.',
      isOpen: false
    },
    {
      id: 5,
      question: 'Can I cancel anytime?',
      answer: 'Of course. There are no long contracts or penalties. You can cancel your subscription anytime from your control panel with one click.',
      isOpen: false
    }
  ])
  ...
  const startFreeTrial = async () => {
    try {
      ...
      console.log('Starting free trial...', error)
    }
  }
  ...
  const contactExpert = async () => {
    try {
      ...
      console.log('Contacting expert...', error)
    }
  }
  ...
  const heroStats = computed(() => [
    ...
    { value: '7x', label: 'Sales increase' },
    { value: '24/7', label: 'Automatic attention' },
    { value: '70%', label: 'Recovery of interested prospects' }
  ])
