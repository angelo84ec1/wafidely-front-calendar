...
<section class="hero-bg min-h-screen flex items-center justify-center relative overflow-hidden">
          ...
          <div class="grid lg:grid-cols-12 gap-8 items-center">
            ...
            <div class="lg:col-span-8 text-center lg:text-left animate-slide-up">
              ...
              <div class="inline-flex items-center bg-white/20 backdrop-blur-sm rounded-full px-6 py-3 mb-8 border border-white/30 shadow-lg">
                <span class="text-white text-sm font-semibold drop-shadow-sm"> Novo: IA Conversacional Avançada  🚀</span>
              </div>
              ...
              <h1 class="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black text-white mb-6 leading-tight drop-shadow-lg">
                Automatize seu<span class="text-green-400 drop-shadow-md">WhatsApp Business</span><br>
                com  <span class="text-blue-400 drop-shadow-md">Inteligência Artificial</span>
              </h1>
              
              <!-- Subheadline with better contrast -->
              <p class="text-lg md:text-xl lg:text-2xl text-gray-100 mb-8 leading-relaxed drop-shadow-md">
                 Aumente suas vendas até  <strong class="text-yellow-400 text-xl md:text-3xl">7x</strong> com bots inteligentes que respondem como humanos,
               gerenciam agendamentos automaticamente e convertem visitantes em clientes 24/7.
              </p>
              ...
              <div class="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-4 mb-8">
                ...
                >
                  <span class="group-hover:text-green-600 transition-colors">🎯 Começar Teste Grátis</span>
                </button>
              </div>
              ...
              <div class="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-6 text-white">
                <div class="flex items-center gap-3 bg-white/10 backdrop-blur-sm rounded-full px-5 py-2 border border-white/20">
                  ...
                  <span class="text-sm font-semibold drop-shadow-sm">+200 empresas confiam em nós</span>
                </div>
                <div class="flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-5 py-3 border border-white/20">
                  <div class="flex text-yellow-400 text-sm">
                    ⭐⭐⭐⭐⭐
                  </div>
                  <span class="text-sm font-semibold drop-shadow-sm">4.9/5 em avaliações</span>
                </div>
              </div>
            </div>
          ...
          <div class="max-w-6xl mx-auto">
            <div class="text-center mb-16">
              ...
              <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                Milhares de empresas perdem vendas diariamente por não conseguir atender o WhatsApp 24/7
              </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
              <!-- Problems -->
              <div class="space-y-6">
                <h3 class="text-2xl font-bold text-red-600 mb-6">❌ Sem Wafidely AI</h3>
                <div class="space-y-4">
                  <div 
              ...
              <!-- Solutions -->
              <div class="space-y-6">
                <h3 class="text-2xl font-bold text-green-600 mb-6">✅ Com Wafidely AI</h3>
                <div class="space-y-4">
                  <div 
        ...
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-3xl md:text-5xl font-bold text-gray-800 mb-4">
              Recursos que <span class="gradient-text">Revolucionam</span> seu Negócio
            </h2>
            <p class="text-xl text-gray-600 max-w-3xl mx-auto">
              Tecnologia de ponta projetada para maximizar suas conversões e automatizar completamente seu WhatsApp Business
            </p>
          </div>
        ...
        <div class="container mx-auto px-4 text-center">
          <div class="max-w-4xl mx-auto">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-4">
              Veja o Wafidely AI em Ação
            </h2>
            <p class="text-xl text-green-100 mb-12">
              Demonstração do nosso gerenciador de integração com WhatsApp Business 
            </p>
    ...
    <div class="relative bg-white bg-opacity-10 rounded-2xl p-8 backdrop-filter backdrop-blur-lg">
      ...
      <p class="text-white mt-4 text-sm opacity-90">
        📹 Demo de 6 minutos: Passos para integrar WhatsApp Business com IA, criação de funil de vendas e lembretes de agendamentos
      </p>
    </div>
            ...
            <div class="grid grid-cols-3 gap-8 mt-12 text-white">
              <div>
                ...
                <p class="text-green-100">Aumento em leads</p>
              </div>
              <div>
                <div class="text-3xl font-bold mb-2">6 min</div>
                <p class="text-green-100">Tempo de integração</p>
              </div>
              <div>
                <div class="text-3xl font-bold mb-2">100%</div>
                <p class="text-green-100">Escalável</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            ...
            <p class="text-xl text-gray-600">
              Mais de 200 empresas confiam no Wafidely AI para automatizar suas vendas
            </p>
          </div>
      ...
      <section id="pricing" class="py-20 bg-white">
        <div class="container mx-auto px-4">
          <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-800 mb-4">
              Planos que se Adaptam ao seu <span class="gradient-text">Crescimento</span>
            </h2>
            <p class="text-xl text-gray-600 mb-8">
              Comece grátis e escale conforme suas necessidades. Sem surpresas, sem compromissos longos.
            </p>
            ...
            <div class="flex items-center justify-center gap-4 mb-12">
              ...
              <span class="text-green-600 font-semibold">Anual (2 meses grátis)</span>
            </div>
          </div>
                ...
                >
                  ...
                  >
                    ...
                    <div class="text-center mb-8">
                      ...
                      <p class="text-gray-600">{{ plan.id === 0 ? 'Por 5 dias' : (isAnnual ? 'Por ano' : 'Por mês') }}</p>
                    </div>
  ...
  <div class="text-center mb-6">
    ...
    <div class="bg-gray-90 text-gray-500 px-4 py-2 rounded-t-lg text-sm font-semibold">
      Inclui respostas automáticas de IA para vendas, suporte e atendimento ao cliente em:
    </div>
    
    <!-- Social Icons Container -->
    <div class="bg-gray-50 p-4 rounded-b-lg border border-gray-200">
      <div class="flex justify-center items-center space-x-4">
        ...
        <div class="flex justify-center items-center space-x-6">
          ...
          <!-- Facebook Icon -->
          <a 
            href="https://facebook.com/wafidely" 
            target="_blank" 
            rel="noopener noreferrer"
            class="group bg-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
          >
            <svg 
          ...
          >
            <svg 
              class="w-6 h-6 text-green-500 group-hover:text-green-600 transition-colors" 
              fill="currentColor" 
              viewBox="0 0 24 24"
            >
              <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893A11.821 11.821 0 0020.465 3.488"/>
          ...
          <!-- Email Icon -->
          <a 
            href="mailto:contacto@wafidely.com" 
            class="group bg-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
          >
            <svg 
              class="w-6 h-6 text-gray-600 group-hover:text-gray-700 transition-colors" 
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24"
            >
          ...
          <!-- Instagram Icon -->
          <a 
            href="https://instagram.com/wafidely" 
            target="_blank" 
            rel="noopener noreferrer"
            class="group bg-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-110"
          >
            <svg 
              class="w-6 h-6 text-pink-500 group-hover:text-pink-600 transition-colors" 
              fill="currentColor" 
              viewBox="0 0 24 24"
            >
              <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
          ...
          <div class="text-center mt-12">
            <div class="inline-flex items-center gap-3 bg-[#38f5b3] px-6 py-4 rounded-full border border-[#38f5b3]">
              ...
              <span class="text-gray-700 font-semibold">Nossa garantia é o teste GRATUITO de 5 dias sem cartão de crédito</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container mx-auto px-4">
          <div class="max-w-4xl mx-auto">
            <div class="text-center mb-16">
              ...
              <p class="text-xl text-gray-600">
                Esclarecemos suas dúvidas mais comuns sobre o Wafidely AI
              </p>
            </div>
        ...
        <div class="container mx-auto px-4 text-center">
          <div class="max-w-4xl mx-auto">
            ...
            <p class="text-xl md:text-2xl text-green-100 mb-8">
              Junte-se a mais de 200 empresas que já automatizaram seu WhatsApp Business com IA
            </p>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
              ...
              >
                ⏱️ 🚀 Agende sua Demo 1:1 GRÁTIS - Descubra o Poder da IA
              </button>
            </div>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-8 text-green-100 mb-12">
              ...
              <div class="flex items-center gap-2">
                <span class="text-lg">✅</span>
                <span>Instalação gratuita na nuvem</span>
              </div>
              <div class="flex items-center gap-2">
                <span class="text-lg">✅</span>
            ...
            <div class="bg-white bg-opacity-10 rounded-xl p-6 backdrop-filter backdrop-blur-lg">
              ...
              <p class="text-green-100">Os 3 planos incluem por mês 37.000 a 57.000 conversas de entrada e saída com OpenAI </p>
              <div class="mt-4 text-2xl font-bold">⏱️ {{ remainingSpots }} vagas restantes</div>
            </div>
          </div>
        </div>
      </section>
  ...
  useSeoMeta({
    title: 'Wafidely AI - Automatize seu WhatsApp Business com Inteligência Artificial',
    ogTitle: 'Wafidely AI - Automatize seu WhatsApp Business com IA',
    description: 'Aumente suas vendas até 7x com Wafidely AI. Automação completa do WhatsApp Business, bots inteligentes, IA conversacional e gestão de clientes 24/7. Teste grátis.',
    ogDescription: 'Aumente suas vendas até 7x com automação inteligente do WhatsApp Business. Bots com IA, respostas automáticas e gestão completa de clientes.',
    ogImage: '/images/wafidely-ai-og.jpg',
    ogUrl: 'https://www.wafidely.com/ai',
    twitterTitle: 'Wafidely AI - Automatize seu WhatsApp Business com IA',
    twitterDescription: 'Aumente suas vendas até 7x com automação inteligente do WhatsApp Business.',
  ...
  useHead({
    ...
    link: [
      {
        rel: 'canonical',
        href: 'https://www.wafidely.com/ai-br'
      }
    ]
  })
  ...
  const setupVideo = () => {
    if (demoVideo.value && isInitialSetup.value) {
      // Usar um timeout para assegurar que o vídeo esteja completamente carregado
      setTimeout(() => {
        if (demoVideo.value) {
          demoVideo.value.currentTime = 3 // Estabelecer em 3 segundos (0:03)
  ...
  const onSeeked = () => {
    // Assegurar que pause após buscar a posição inicial
  ...
  const onPlay = () => {
    if (demoVideo.value && !hasStartedPlaying.value) {
      // Primeira vez que pressionam play - reiniciar do segundo 0
  ...
  const subscribe = (plan: PricingPlan) => {
    // Se for o plano WAPersonalizado (id: 5), dirigir para WhatsApp
    if (plan.id === 5) {
      const whatsappNumber = '593983314957'
      const message = `Olá, estou interessado no plano ${plan.name}. Gostaria de obter mais informações sobre a solução personalizada.`
    ...
    // Para todos os outros planos, comportamento normal
  ...
  const hasDiscount = (plan: PricingPlan) => {
    if (isAnnual.value) {
      // Para planos anuais, sempre há desconto (2 meses grátis)
      return true
    } else {
      // Para planos mensais, verificar se há descountPrice
  ...
  const getOriginalPrice = (plan: PricingPlan) => {
    if (isAnnual.value) {
      // Preço original anual seria 12 meses do preço mensal
  ...
  const getDisplayPrice = (plan: PricingPlan) => {
    if (isAnnual.value) {
      // Para anual, mostrar o preço anual (que inclui 2 meses grátis)
      return plan.annualPrice
    } else {
      // Para mensal, mostrar descountPrice se existe, senão monthlyPrice
  ...
  const getDiscountPercentage = (plan: PricingPlan) => {
    ...
    // Evitar divisão por zero para o plano gratuito
  ...
  const problems = ref<Problem[]>([
    {
      id: 1,
      title: 'Respostas lentas ou perdidas',
      description: 'Os clientes esperam respostas imediatas, mas sua equipe não pode estar disponível 24/7'
    },
    {
      id: 2,
      title: 'Gestão manual avassaladora',
      description: 'Responder cada mensagem individualmente consome tempo e recursos valiosos'
    },
    {
      id: 3,
      title: 'Vendas perdidas',
      description: 'Clientes interessados vão para a concorrência por falta de atendimento imediato'
    }
  ])
  ...
  const solutions = ref<Solution[]>([
    {
      id: 1,
      title: 'Respostas instantâneas com IA',
      description: 'Bots inteligentes respondem em segundos, 24 horas por dia, 7 dias por semana'
    },
    {
      id: 2,
      title: 'Automação completa',
      description: 'Gerencia milhares de conversas simultâneas sem intervenção manual'
    },
    {
      id: 3,
      title: 'Conversões maximizadas',
      description: 'Cada visitante se converte em oportunidade de venda com acompanhamento automático'
    }
  ])
  ...
  const mainFeatures = ref<MainFeature[]>([
    {
      ...
      description: 'Chatbots que entendem contexto e respondem como humanos usando tecnologia GPT',
    ...
    },
    {
      id: 2,
      title: 'Automação Completa',
      description: 'Fluxos de trabalho automáticos que gerenciam todo o ciclo de vendas sem intervenção',
      iconPath: 'M13 10V3L4 14h7v7l9-11h-7z',
      benefits: [
        'Segmentação automática de leads',
        'Acompanhamento personalizado',
        'Recuperação de contatos não atendidos'
      ]
    },
    {
      id: 3,
      title: 'Analytics Inteligentes',
      description: 'Métricas detalhadas e insights acionáveis para otimizar sua estratégia',
      iconPath: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z',
      benefits: [
        'Dashboards em tempo real',
        'Rastreamento de ROI avançado',
        'Estado de consumo de tokens da IA'
      ]
    }
  ])
  ...
  const extraFeatures = ref<ExtraFeature[]>([
    {
      ...
      description: 'Prioriza automaticamente os leads com maior potencial',
      emoji: '🎯'
    },
    {
      id: 2,
      title: 'Integração com mais de 30 Webhooks',
      description: 'Sincroniza com suas ferramentas favoritas automaticamente',
      emoji: '🔄'
    },
    {
      id: 3,
      title: 'Agendamento IA',
      description: 'Programa consultas automaticamente segundo disponibilidade',
      emoji: '📅'
    },
    {
      id: 4,
      title: 'Multi-idioma',
      description: 'Atende clientes em mais de 3 idiomas automaticamente',
      emoji: '🌍'
    }
  ])
  ...
  const testimonials = ref<Testimonial[]>([
    {
      ...
      initials: 'RC',
      quote: 'Wafidely AI transformou completamente nosso negócio. Em apenas 2 meses aumentamos nossas vendas em 200% e agora atendemos clientes 24/7 sem esforço adicional no aluguel de carros.',
      result: 'Resultado: +200% em vendas'
    },
    {
      id: 2,
      name: 'Hugo Moncayo',
      position: 'Diretor, Pet Vetsgoo',
      initials: 'HM',
      quote: 'A automação do Wafidely nos permite lembrar aos pacientes centenas de consultas médicas. Nossa equipe se concentra em manter a agenda cheia de pacientes sem faltas.',
      result: 'Resultado: 80% menos faltas'
    },
    {
      id: 3,
      name: 'Ana García',
      position: 'Fundadora, Clínica Dental Moderna',
      initials: 'AG',
      quote: 'O agendamento automático de consultas mudou nossas vidas. Os pacientes podem agendar 24/7 e nós confirmamos automaticamente. Incrível!',
      result: 'Resultado: +310% consultas agendadas'
    }
  ])
  ...
  const pricingPlans = ref<PricingPlan[]>([
    {
      id: 0,
      name: 'WAGrátis',
      description: 'Teste gratuito para conhecer nosso serviço',
      descountPrice: 0,
      monthlyPrice: 0,
      annualPrice: 0,
      popular: false,
      ...
      features: [
        '1 Construtor de Fluxo',
        '2 Números de WhatsApp para integrar',
        '1000 Tokens de IA por 5 dias',
        'Suporte Gratuito para criar conta'
      ]
    },
    {
      id: 1,
      ...
      features: [
        '3 Construtores de Fluxo completo',
        'Até 75 conversas/mês',
        '4.000-8.000 tokens de IA',
        'Até 300 contatos em campanhas',
        'Suporte por WhatsApp'
      ]
    },
    {
      id: 2,
      name: 'WAPequenaEmpresa',
      description: 'Perfeito para PMEs com usuários moderados',
      descountPrice: 275,
      monthlyPrice: 355,
      annualPrice: 2750,
      popular: false,
      buttonText: 'Começar Agora',
      features: [
        'Lembrete automático até 100 consultas',
        'Construtor de Fluxo avançado',
        'Página gerada automaticamente',
        'Relatórios completos',
        'Até 140 conversas/mês',
        '17.000-20.000 tokens de IA',
        'Até 500 contatos em campanhas',
        'Suporte prioritário'
      ]
    },
    {
      ...
      buttonText: 'Começar',
      features: [
        'Lembrete automático até 300 consultas',
        'API completa do WhatsApp',
        'Página de destino gerada automaticamente com calendário',
        'Analytics avançados',
        'Até 350 conversas/mês',
        '20.000-29.000 tokens de IA',
        'Até 1.000 contatos em campanhas',
        'Suporte 24/7'
      ]
    },
    {
      ...
      buttonText: 'Começar',
      features: [
        'Lembrete automático até 1.000 consultas',
        'API empresarial completa',
        'Página de destino gerada automaticamente com calendário',
        'Múltiples integrações',
        'Relatórios personalizados',
        'Até 720 conversas/mês',
        '29.000-67.000 tokens de IA',
        'Até 5.000 contatos em campanhas',
    ...
    {
      id: 5,
      name: 'WAPersonalizado',
      description: 'Para empresas com vários sistemas',
      descountPrice: 'flexível',
      monthlyPrice: 'flexível',
      annualPrice: 'flexível',
      popular: false,
      buttonText: 'Começar',
      features: [
        'Lembrete automático até 5.000 consultas',
        'API empresarial com integração a sistemas existentes da empresa',
        'Múltiplas integrações',
        'Relatórios personalizados',
        'Conversas/mês ilimitadas',
        'Tokens de IA ilimitados',
        'A partir de 100.000 contatos em campanhas',
        'Gerente de conta dedicado'
      ]
    }
  ])
  ...
  const faqs = ref<FAQ[]>([
    {
      id: 1,
      question: 'Quão difícil é configurar o Wafidely AI?',
      answer: 'Super fácil. Nosso assistente de configuração te guia passo a passo e você pode ter seu primeiro bot funcionando em menos de 10 minutos. Além disso, nossa equipe te ajuda gratuitamente com a configuração inicial.',
      isOpen: false
    },
    {
      id: 2,
      question: 'Funciona com meu WhatsApp Business atual?',
      answer: 'Absolutamente! O Wafidely AI se integra perfeitamente com sua conta do WhatsApp Business existente. Você não precisa mudar números nem perder seu histórico de conversas.',
      isOpen: false
    },
    {
      id: 3,
      question: 'E se meus clientes perceberem que é um bot?',
      answer: 'Nossos bots com IA são tão naturais que 95% dos clientes não notam a diferença. E se precisarem de atendimento humano, o bot transfere automaticamente a conversa para sua equipe.',
      isOpen: false
    },
    {
      id: 4,
      question: 'Quanto tempo leva para ver resultados?',
      answer: 'Nossos clientes tipicamente veem um aumento em leads de 130-300% nas primeiras 2 semanas. Os resultados de vendas geralmente são vistos entre 15-30 dias após a implementação.',
      isOpen: false
    },
    {
      id: 5,
      question: 'Posso cancelar quando quiser?',
      answer: 'Claro. Não há contratos longos nem penalizações. Você pode cancelar sua assinatura a qualquer momento do seu painel de controle com um só clique.',
      isOpen: false
    }
  ])
  ...
  const startFreeTrial = async () => {
    try {
      ...
      console.log('Iniciando teste gratuito...', error)
    }
  }
  
  const watchDemo = () => {
    console.log('Abrindo demo do vídeo...')
  }
  
  const playVideo = () => {
    console.log('Reproduzindo demo do vídeo...')
  }
  ...
  const contactExpert = async () => {
    try {
      ...
      console.log('Contatando especialista...', error)
    }
  }
  ...
  const heroStats = computed(() => [
    ...
    { value: '7x', label: 'Aumento em vendas' },
    { value: '24/7', label: 'Atendimento automático' },
    { value: '70%', label: 'Recuperação de interessados' }
  ])
